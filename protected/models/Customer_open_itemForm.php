 ...
 **/
class Customer_open_itemForm extends CFormModel
{
    public $username;
    public $password;
    public $rememberMe;
    ...
    **/
     ...
     public function _actionSubmit($doc, $screen, $fce)
    {
		...
		$res = $fce->invoke(['CUSTOMER'=> $cust_num,
            ...
            $ids=1;	
            $table_labels  = "DOC_NO,INV_REF,DOC_DATE,BLINE_DATE,LOC_CURRCY,REF_DOC_NO,ALLOC_NMBR";
            $labels        = "DOC_NO,INV_REF,DOC_DATE,BLINE_DATE,LOC_CURRCY,REF_DOC_NO,ALLOC_NMBR";
            $tableField1 = $screen.'_Customer_open_items_head';
    ...
    {
			$table_inf  = "DOC_NO,INV_REF,DOC_DATE,BLINE_DATE,LOC_CURRCY,REF_DOC_NO,ALLOC_NMBR";
            $labels_inf        = "DOC_NO,INV_REF,DOC_DATE,BLINE_DATE,LOC_CURRCY,REF_DOC_NO,ALLOC_NMBR";
		$tableField1  = $screen.'_Customer_open_items_head';
		if(isset($doc->customize->$tableField1->Table_order))
		{			
