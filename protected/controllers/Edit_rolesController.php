<?php
class Edit_rolesController extends Controller
{
	/**
	...
	*/        
	 ...
	 */
	public function actionEdit_roles()
	{
    ...
    public function actionGetroles()
    {
		if(Yii::app()->user->hasState("login"))
        {
			...
			if(isset($_POST))
			{
				Yii::app()->controller->renderPartial('roles', array('model' => $model, 'edit_role' => $_POST['role']));
			}
        }
	}
    ...
    public function actionCreateroles()
    {
        if(Yii::app()->user->hasState("login"))
        {
			...
			if(isset($_POST))
			{
				$role		= isset($_POST['ROLE_NAME']) ? $_POST['ROLE_NAME'] : "";
