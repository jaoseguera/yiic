...
<div class="controls">
    <label><?php echo $form->textField($model,'street',array('class'=>'validate[required] input-fluid span8', 'name'=>'fname', 'name'=>'street', 'placeholder'=>'Street','tabindex'=>'10','id'=>'input10')); ?>
...
<div class="controls">
    <label><?php echo $form->textField($model,'city',array('class'=>'validate[required,custom[onlyLetterSp]] input-fluid span8', 'name'=>'city', 'placeholder'=>'City','tabindex'=>'11','id'=>'input11')); ?>
...
<div class="controls">
    <label><?php echo $form->textField($model,'state',array('class'=>'validate[required,custom[onlyLetterSp]] input-fluid span8', 'name'=>'state', 'placeholder'=>'State','tabindex'=>'12','id'=>'input12')); ?>
...
<div class="controls">
    <label><?php echo $form->textField($model,'phone',array('class'=>'validate[required, custom[phone]] input-fluid span8', 'name'=>'phone', 'placeholder'=>'Eg. 555-555-5555','tabindex'=>'14','id'=>'input14')); ?>
...
<div class="controls">
    <label><?php echo $form->textField($model,'company',array('class'=>'validate[required,custom[onlyLetterSp]] input-fluid span8', 'name'=>'company', 'placeholder'=>'Company Name','tabindex'=>'15','id'=>'input15')); ?>
