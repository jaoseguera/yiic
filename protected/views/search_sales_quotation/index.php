...
?><section id='utopia-wizard-form' class="utopia-widget utopia-form-box">
	<div class="row-fluid">
		<div class="utopia-widget-content inval38">
			<form id="validation_ser" action="" class="form-horizontal">
				<input type="hidden" name='page' value="bapi">
				<input type="hidden" name="url" value="search_sales_quotation"/>
				...
				<fieldset class="span12 iphone_sales_textBox" >
					...
					<div class="span3 utopia-form-freeSpace">
						<fieldset>
							...
							<input alt="Date" type="text" name='sales_order_date' id='from' class="input-fluid getval radius" />&nbsp;</span><br/>
						</fieldset>
					</div>
					...
					<div class="span3 utopia-form-freeSpace">
						<fieldset>
							...
							<input alt="To Date" type="text" name='sales_order_dateto' id='to' class="input-fluid getval radius" />&nbsp;</span><br/>
						</fieldset>
					</div>                                       
				</fieldset>
                ...
                <fieldset class="span12 iphone_sales_textBox" >
                     <div class="span3 utopia-form-freeSpace">
                        <fieldset>
                            <label style="text-align: left;" class="control-label cutz" alt="<?=_SALEQUOTATIONNUMBER?>" for="SALES_DOCUMENT"><?=Controller::customize_label(_SALEQUOTATIONNUMBER);?>:</label>
                             <input id='SALES_DOCUMENT' class="input-fluid validate[required] " type="text" name='SALES_DOCUMENT' /><span class='minw' onclick="lookup('<?=_SALESDOCUMENT?>', 'SALES_DOCUMENT', 'sales_document')" >&nbsp;</span>
                        </fieldset>
                    </div>
                </fieldset>

				<div class="span3 utopia-form-freeSpace" style="margin-bottom:10px; float:right; padding-left:33px;">
						<input type="submit"  id="list" class="btn btn-primary span3 bbt back_b iphone_sales_submit iphone_Sale_submit" 
						onclick="return getBapitable('table_todays','BAPIORDERS','examples','L','show_menu@<?php echo $s_wid;?>','Search_sales_quotation','submit')" style="min-width:90px;" value="<?=Controller::customize_label(_SUBMIT);?>" />
				</div>                   
			</form>
		</div>
	</div>
				...
				<div>
					...
					// if($SalesOrder==NULL) {
						...
						<div class="head_icons" style="width:872px;">
							<span id='post' tip="<?=Controller::customize_label(_TABLECOLUMNS);?>" class="yellow post_col" onClick="table_cells('examples')"></span>
						...
						<div class='testr table_todays' onClick='getBapitable("table_todays","BAPIORDERS","examples","S","show_menu@<?php echo $s_wid;?>","Search_sales_orders","show_more")'><?=_SHOWMORE?></div>
...
{
	$('<div style="border:1px solid #FAFAFA;overflow-y:hidden;overflow-x:scroll;" class="tb_scroll">').insertBefore($('#examples'));
alert('hai');
	}
		})
...
jQuery("#validation_ser").validationEngine();
});
/*$(document).ready(function() 
{
    $(document).ready(function() 
