...
FixedHeader.prototype = {
	...
	_fnCloneTable: function ( sType, sClass, fnClone )
	{
		...
		var ids=nCTable.getAttribute('id');
		nCTable.removeAttribute( 'id' );
		
		var nDiv = document.createElement( 'div' );
		nDiv.setAttribute('id',ids+'fix');
		nDiv.setAttribute('class','head_fix');
	...
	_fnScrollFixedHeader: function ( oCache )
	{
		...
		if ( oMes.iTableTop-100 > oWin.iScrollTop + s.oOffset.top )
		{
			/* Above the table */
			this._fnUpdateCache( oCache, 'sPosition', "absolute", 'position', nTable.style );
			this._fnUpdateCache( oCache, 'sTop', oMes.iTableTop+"px", 'top', nTable.style );
		...
		{
			//alert(oMes.iTableTop +">"+s.oOffset.top);
			...
			else
			{
				...
				this._fnUpdateCache( oCache, 'sPosition', 'fixed', 'position', nTable.style );
				this._fnUpdateCache( oCache, 'sTop', "82px", 'top', nTable.style );
				this._fnUpdateCache( oCache, 'sLeft', (oMes.iTableLeft-oWin.iScrollLeft)+"px", 'left', nTable.style );
			}
		}
	},
